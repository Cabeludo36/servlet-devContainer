<html>
<body>
    <a href="/arquivosEstaticos/index.jsp"><-- Back to Index</a>
    <br>
    <h1>Create Person</h1>
    <form action="/arquivosEstaticos/api/pessoassr" method="post">
        ...
        %>
            <li>
                <div style="display:flex;">
                    <form action="/arquivosEstaticos/api/pessoassr/update/<%= pessoa.getId() %>" method="post">
                    ...
                    <form action="/arquivosEstaticos/api/pessoassr/delete/<%= pessoa.getId() %>" method="post" style="display:inline;">
